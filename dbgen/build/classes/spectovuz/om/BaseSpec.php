...
/**
 * Base class that represents a row from the 'spec' table.
 *
 *
 *
 * @package    propel.generator.spectovuz.om
 */
abstract class BaseSpec extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
     ...
     * @return Spec The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = SpecPeer::ID;
        }
    ...
    public function setTitle($v)
    {
        ...
        if ($this->title !== $v) {
            $this->title = $v;
            $this->modifiedColumns[] = SpecPeer::TITLE;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 2; // 2 = SpecPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating Spec object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = SpecPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                SpecPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(SpecPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`ID`';
        }
        if ($this->isColumnModified(SpecPeer::TITLE)) {
            $modifiedColumns[':p' . $index++]  = '`TITLE`';
        }

        $sql = sprintf(
            'INSERT INTO `spec` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = SpecPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = SpecPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['Spec'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Spec'][$this->getPrimaryKey()] = true;
        $keys = SpecPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(SpecPeer::ID)) $criteria->add(SpecPeer::ID, $this->id);
        if ($this->isColumnModified(SpecPeer::TITLE)) $criteria->add(SpecPeer::TITLE, $this->title);
    ...
    {
        $criteria = new Criteria(SpecPeer::DATABASE_NAME);
        $criteria->add(SpecPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of Spec (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return Spec Clone of current object.
     * @throws PropelException
     */
     ...
     * If this Spec is new, it will return
     ...
     * Otherwise if this Spec is new, it will return
     * an empty collection; or if this Spec has previously
     * been saved, it will retrieve related SpecToVuzs from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in Spec.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
     ...
     * @return PropelObjectCollection|SpecToVuz[] List of SpecToVuz objects
     */
    public function getSpecToVuzsJoinVuz($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = SpecToVuzQuery::create(null, $criteria);
        $query->joinWith('Vuz', $join_behavior);
    ...
    {
        return (string) $this->exportTo(SpecPeer::DEFAULT_STRING_FORMAT);
    }
